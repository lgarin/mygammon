...
shared final class AcknowledgeRollMessage(shared actual String gameId, shared actual String playerId) satisfies InboundGameMessage {}
shared final class RollTimeoutMessage(shared actual String gameId, shared actual String playerId) satisfies InboundGameMessage {}
